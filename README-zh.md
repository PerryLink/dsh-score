...
| 组件 | 版本 |
|---|---|
| DeepSeek Harness | **`dsh-v0.1.7-alpha.1`**（GitHub tag；peer 区间已承认 alpha.2 线：`>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0 \|\| >=0.1.6-0 <0.2.0`）。dev/test 钉号与 `typecheck:ci` 尺子仍对照已发布的 `0.1.5-rc.2` 线（2026-09-18 已核验：类型门 + 单元/装配测试 + 制品构建）；alpha.2 线上无插件代码改动。 |
