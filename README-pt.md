...
| Componente | Versão |
|---|---|
| DeepSeek Harness | **`dsh-v0.1.7-alpha.1`** (tag do GitHub; o intervalo de pares admite a linha alpha.2: `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0 \|\| >=0.1.6-0 <0.2.0`). Os pins de dev/test e a régua `typecheck:ci` continuam medindo a linha publicada `0.1.5-rc.2` (verificado em 2026-09-18: portas de tipos, suítes unitárias/de montagem, build de artefatos); nenhum código do plugin mudou para a linha alpha.2. |
