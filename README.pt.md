...
| Componente | Versão |
|---|---|
| DeepSeek Harness | `0.1.2-rc.1` (dependências de pares `>=0.1.2-rc.1 <0.2.0`) (adaptado em 2026-09-04): o envelope de sessão mantém seu campo ignorable apenas para compatibilidade de leitura de logs armazenados - o Session.append ainda não consegue estampá-lo, então o comportamento da porta não muda. |
