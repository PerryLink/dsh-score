...
| घटक | संस्करण |
|---|---|
| DeepSeek Harness | **`dsh-v0.1.5-alpha.1`** (GitHub tag; 2026-09-09 को सत्यापित: टाइप गेट, यूनिट/असेंबली सूट, आर्टिफ़ैक्ट बिल्ड)। प्रकाशित npm लाइन `0.1.5-alpha.1` (npm `latest` अभी भी `0.1.2-rc.1` है; peer निर्भरताएँ `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0`)。 |
