...
| घटक | संस्करण |
|---|---|
| DeepSeek Harness | **`dsh-v0.1.7-alpha.2`** (GitHub tag; peer रेंज alpha.2 लाइन को स्वीकार करती है: `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0 \|\| >=0.1.6-0 <0.2.0 \|\| >=0.1.7-0 <0.2.0`)। dev/test पिन और `typecheck:ci` रूलर अब भी प्रकाशित `0.1.5-rc.2` लाइन को मापते हैं (2026-09-18 को सत्यापित: टाइप गेट, यूनिट/असेंबली सूट, आर्टिफ़ैक्ट बिल्ड); alpha.2 लाइन के लिए प्लगइन कोड में कोई बदलाव नहीं। |
